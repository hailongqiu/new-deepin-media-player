...
class Mpris2Adapter(dbus.service.Object):
    ...
    def Next(self):
        self.this.next()
        self.populate(ORG_MPRIS_MEDIAPLAYER2_PLAYER,
    ...
    def Metadata(self):
        ldmp = self.this.ldmp
        return self.__get_metadata(ldmp)
    ...
    def __get_metadata(self, ldmp):
        ...
        if True:
            ...
            meta['xesam:title'] = ldmp.player.uri #song.get_str("title")
            '''
